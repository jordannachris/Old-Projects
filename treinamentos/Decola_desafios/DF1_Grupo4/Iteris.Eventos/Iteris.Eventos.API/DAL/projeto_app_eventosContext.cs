...
namespace Iteris.Eventos.API.DAL
{
    public partial class projeto_app_eventosContext : DbContext
    {
        public projeto_app_eventosContext()
        {
        }

        public projeto_app_eventosContext(DbContextOptions<projeto_app_eventosContext> options)
            : base(options)
        {
        }
